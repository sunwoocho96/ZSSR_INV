...
def main():
    ...
    # args.input_dir = '../data/datasets/DIV2KRK/lr_x2'
    ...
    args.output_dir = '../data/log_KernelGANFKP/{}_{}_{}_lr_x{}'.format(timestr, args.dataset, args.model, 4 if args.X4 else 2)

    # load nonblind model
    if args.SR:
        netG = USRNet(n_iter=6, h_nc=32, in_nc=4, out_nc=3, nc=[16, 32, 64, 64],
                      nb=2, act_mode="R", downsample_mode='strideconv', upsample_mode="convtranspose", k_batch=1)
